...
| Updater plugin initialized in Rust | ✅ Done | `src-tauri/src/lib.rs` (.setup block) |
| Updater config in tauri.conf.json | ⚠️ Partial — pubkey is placeholder | `src-tauri/tauri.conf.json` |
