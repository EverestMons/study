...
**Updated By:** Product Analyst (post Materials Grid Redesign + Icon Update)
...
| Systems Architecture | Active | 2026-03-11 | Materials grid redesign architecture + reuse pattern (`knowledge/architecture/materials-grid-redesign-2026-03-11.md`). Previous: performance (P1-P4) + stability v2 architectures. |
| Development | Active | 2026-03-11 | Latest: Materials screen redesigned (grouped grid + expand-in-place), material processing states fixed (queued vs reading), Stop button on active processing, app icon update. Previous: hardening pass. |
...
| Design & Experience | Active | 2026-03-11 | Materials grid UX direction (`knowledge/design/materials-grid-ux-2026-03-11.md`). Previous: character sheet UX design + validation. |
...
| Source files | 51 JS/JSX files (MaterialsScreen.jsx restructured from 674 to 584 lines) |
| Total LOC | ~16,230 |
...
| Screens | 9 | 2,154 | MaterialsScreen (584), ProfileScreen (522), ScheduleScreen (324), UploadScreen (169), HomeScreen (162), SkillsScreen (122), StudyScreen (111), NotifsScreen (73), ManageScreen (64) |
